...
struct meshResource
{
	...
	struct vertex
	{
		...
		vertex() : position(vec3(0, 0, 0)), textureCoordinates(vec2(0, 0)) {}
		vertex(vec3 const& position, vec2 const& textureCoordinates) : position(position), textureCoordinates(textureCoordinates) {}
	};
